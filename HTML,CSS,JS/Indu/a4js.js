...
function insert() {
    // for sequence
    // if(arrValIndex < array.length)
    // {
    //     array.push(arrValIndex+1);
    //     document.getElementById('seq').value = array[arrValIndex+1];
    // }
    //     arrValIndex++;
    //for inserting the values
    //  let id = document.getElementById("seq").value;
    ...
    let newRow = "<tr><td>" + username + "</td><td>" + email + "</td><td>" + phonenumber + "</td></tr>";
